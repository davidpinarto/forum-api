...
DomainErrorTranslator._directories = {
  ...
  'ADD_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('Gagal menambahkan komentar karena body request tidak lengkap'),
  'ADD_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('Gagal menambahkan komentar karena type data tidak sesuai'),
};
